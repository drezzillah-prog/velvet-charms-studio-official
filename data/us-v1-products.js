...
export const US_V1_PRODUCTS = [
  ...
  { id:"us_refill_body_butter_100", name:"Body Butter Refill", size:"100 ml", formulaBatchBasis:"100 g prototype", family:"Refills", formulaCode:"VC-BB-001-R", version:"1.0", formula:[["Shea Butter, cosmetic grade",55],["Sweet Almond Oil",24],["Jojoba Oil",15],["Beeswax",5],["Tocopherol / Vitamin E",1]], positioning:"Lower-waste refill using the same Body Butter master formula as the original V1 product.", launchStatus:prelaunch },
  { id:"us_refill_face_balm_50", name:"Nourishing Face Balm Refill", size:"50 ml", formulaBatchBasis:"100 g prototype", family:"Refills", formulaCode:"VC-FB-001-R", version:"1.0", formula:[["Jojoba Oil",45],["Squalane, documented cosmetic grade",25],["Shea Butter",20],["Beeswax",9],["Tocopherol",1]], positioning:"Lower-waste refill using the same Nourishing Face Balm master formula as the original V1 product.", launchStatus:prelaunch },
  { id:"us_refill_hand_foot_balm_50", name:"Hand & Foot Balm Refill", size:"50 ml", formulaBatchBasis:"100 g prototype", family:"Refills", formulaCode:"VC-HFB-001-R", version:"1.0", formula:[["Shea Butter",45],["Sweet Almond Oil",25],["Jojoba Oil",15],["Beeswax",14],["Tocopherol",1]], positioning:"Lower-waste refill using the same Hand & Foot Balm master formula as the original V1 product.", launchStatus:prelaunch },
...
export const US_V1_FAMILIES = ["Body Butter","Face Balm","Hand & Foot Balm","Refills","Solid Perfume","Perfume Oil Roll-On","Glycerin Soap"];
